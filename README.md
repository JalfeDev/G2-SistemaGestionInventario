...
- [ ] Acepta archivos .csv con columnas: nombre, stockActual, stockMinimo, categoría y unidad de medida (obligatorias nombre y stockMinimo; categoría y unidad son opcionales)
...
### Por Sprint (cronología real de desarrollo en GitHub)
 
| Sprint | HUs (numeración de este README) | Puntos | Fechas |
|--------|----------------------------------|--------|--------|
...
### Por Release (agrupación usada en el documento de arquitectura / Word)
...
> **Nota de consistencia:** la numeración de HU de este README fue actualizada para coincidir con la Tabla 1 y la Tabla 2 del documento de arquitectura (antes tenía una numeración distinta, heredada del tablero original de GitHub). La agrupación por Sprint no coincide exactamente con la agrupación por Release, porque HU-06 (housekeeping), HU-07 (reporte de consumo) y HU-08 (alertas de stock) se completaron en fechas de Sprint 2 aunque documentalmente quedaron clasificadas dentro del Release 1. Se recomienda que el equipo confirme si esto es intencional antes de la sustentación.
...
|-------|-------------|-----|
| P0 | Crítico — el sistema no funciona sin esto | HU-01, HU-02, HU-03, HU-04 |
| P1 | Alta — funcionalidad importante del Release | HU-05, HU-06, HU-07, HU-08, HU-09, HU-10, HU-11, HU-12, HU-14, HU-15 |
| P2 | Media — mejora de comodidad | HU-13 |
